      ...
      <div className="row align-items-start">
        <div className="col-lg-12 px-4">
          ...
          <div className="text-center my-5">
            <h3 className="confirmation-title fw-bold mb-3">Your Consultation has been Booked!</h3>
          </div>

          <div className="confirmation-details text-start mb-4">
            <p className="confirmation-message mb-4 text-center">
              Great! We have booked your appointment. Please see the details below.
            </p>
            ...
            <ul className="list">
              ...
              <li>Reason: {formData.appointmentReasonLabel}</li>
            </ul>

            <p className="reminder-text text-muted mt-3">
              You will receive an Email/SMS reminder one day before your scheduled
              visit. You can manage this appointment from your dashboard.
            </p>
          </div>
