      ...
      <div className="row align-items-start">
            ...
            <div className="col-lg-6 px-4">
              ...
              <div className="row g-3">
                ...
                <div className="col-md-12 mt-3 mx-1">
                  ...
                  <p className="mb-3 text-description">
                    Please review and check the following boxes to complete the registration.
                  </p>
                  <div className="form-check">
                    ...
                    />
                    <label className="form-check-label">I have reviewed all the information and confirm that it is accurate.</label>
                  </div>
                  ...
                  <div className="form-check">
                    <input
                      ...
                      onChange={handleChange}
                    />
                    <label className="form-check-label">I consent to the collection and processing of my personal data for treatment purposes, in accordance with the Data Privacy Act of 2012.</label>
                  </div>
                  ...
                  <div className="form-check">
                    <input
                      ...
                      onChange={handleChange}
                    />
                    <label className="form-check-label">I agree to receive SMS and email reminders for my appointments and vaccination schedule.</label>
                  </div>
                </div>
              ...
              <div className="d-flex justify-content-between align-items-center mt-3">
                <button className="btn btn-primary px-5 py-2 previous-button fs-5" onClick={prevStep}>Previous</button>

                <button className="btn btn-primary px-5 py-2 fs-5" onClick={nextStep}>Submit</button>
              </div>
