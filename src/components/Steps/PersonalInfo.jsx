    ...
    <div className="row align-items-start">
      ...
      <div className="col-lg-6 px-4">
        ...
        <div className="row g-3">
          ...
          >
            ...
            <select
              ...
              className={`form-select mt-1 ${
                showErrors && (formData.sex === '' || formData.sex === 'Select')
                  ? 'is-invalid'
                  : ''
              }`}
              value={formData.sex}
          ...
          <div
            className={`col-md-12 ${
              showErrors && !formData.houseNoStreet ? 'my-0' : ''
            }`}
          >
            ...
            <input
              ...
              name="houseNoStreet"
              className={`form-control mt-1 ${
                showErrors && formData.houseNoStreet === '' ? 'is-invalid' : ''
              }`}
          ...
          >
            ...
            <input
              ...
              name="barangay"
              className={`form-control mt-1 ${
                showErrors && formData.barangay === '' ? 'is-invalid' : ''
              }`}
          ...
          <div
            className={`col-md-6 ${
              showErrors &&
              (!formData.province ||
                !nameRegex.test(formData.province) ||
          ...
          >
            ...
            <input
              ...
              className={`form-control mt-1 ${
                showErrors &&
                (!formData.province || !nameRegex.test(formData.province))
                  ? 'is-invalid'
                  : ''
              }`}
            ...
            {showErrors &&
              ...
              !nameRegex.test(formData.province) && (
                <div className="invalid-feedback d-block">
                  Province must not contain numbers.
                </div>
              )}
          </div>
